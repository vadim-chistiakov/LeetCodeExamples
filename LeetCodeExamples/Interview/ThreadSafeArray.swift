...
//  LeetCodeExamples
//
//  Created by Vadim Chistiakov on 26.01.2022.
//

import Foundation

class ThreadSafeArrayTests {
   
    static func testThreadUnsafeArray() {
        var array = [0]
        var iterations = 1000
    ...
    static func testThreadSafeArrayMini() {
    ...
    static func testThreadSafeArray() {
...
final class ThreadSafeArray<Element> {
    private let queue = DispatchQueue(label: "wheely.com.threadSafeArray", attributes: .concurrent)
